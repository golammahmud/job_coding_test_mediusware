...
from .serializers import (
    ProductSerializer,
    product_variant_price_Seriaizer,
    ProductVariantsSerializers,
)
...
class VariantsViewSet(viewsets.ModelViewSet):
    ...
    serializer_class = ProductVariantsSerializers
...
class ProductView(viewsets.ModelViewSet):
    ...
    search_fields = [
        ...
        "$description",
        "$created_at",
    ]  # http://host/?search=value
    filterset_fields = [
        "title",
        "created_at",
    ]  # http://host/?fieldname=name&secondfield=name
